...
urlpatterns = [
    ...
    path('eliminarcliente/<id>',eliminarClient),
    path('actualizarclient/',clientActualizar),
    ...
    path('eliminarproduct/',eliminarProduct),
    path('actualizarproduct/',productActualizar),
